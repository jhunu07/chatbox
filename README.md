...
A modern, responsive chat application powered by Groq's Llama 3.3 70B model. Built with React and Vite, featuring a sleek UI with memory capabilities and chat history management.
